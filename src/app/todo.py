...
def main():
    ...
    while True:
        ...
        print("[grey37]1. View tasks[/grey37]")
        print("[grey37]2. Add a task[/grey37]")
        print("[grey37]3. Mark task as complete[/grey37]")
        print("[grey37]4. Delete a task[/grey37]")
        print("[grey37]5. Exit[/grey37]")
